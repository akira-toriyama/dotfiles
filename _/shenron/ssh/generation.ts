// deno run --allow-run --allow-read --allow-write --allow-env --allow-sys $(chezmoi source-path)/_/shenron/ssh/generation.ts
...
import { getShenronRoot } from "../service.ts";

const shenronRoot = getShenronRoot();
